<div id="navMenu" class="absolute z-50 hidden w-full bg-white bg-opacity-90">
    ...
    <div class="pt-2 pb-3 space-y-1 text-center border-b border-white prohide-p">
        ...
        <x-jet-responsive-nav-link href="{{ route('digitalmarketing.portfolio') }}" :active="request()->routeIs('digitalmarketing.portfolio')">
            {{ __('PORTFOLIO') }}
        </x-jet-responsive-nav-link>
    </div>
</div>
    ...
    <div class="flex flex-row items-center w-full space-x-10">
        <div class="flex flex-row items-center flex-grow h-20 bg-white rounded-none lg:rounded-r-full bg-opacity-80">
            ...
            <div class="flex flex-row justify-end flex-grow pr-6 space-x-20">
                <a href="{{url('/digitalmarketing')}}" class="hidden p-2 px-10 text-lg text-center text-white transform bg-blue-600 bg-opacity-75 border border-gray-400 rounded-full md:block hover:scale-105">OVERVIEW</a>
                <a href="{{route('digitalmarketing.portfolio')}}" class="hidden p-2 px-10 text-lg text-center text-white transform bg-blue-600 bg-opacity-75 border border-gray-400 rounded-full md:block hover:scale-105">PORTFOLIO</a>
            </div>
        </div>
