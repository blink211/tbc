<div id="navMenu" class="absolute z-50 hidden w-full bg-white bg-opacity-90">
    ...
    <div class="pt-2 pb-3 space-y-1 text-center border-b border-white prohide-p">
        ...
        <x-jet-responsive-nav-link href="{{ route('websites.portfolio') }}" :active="request()->routeIs('websites.portfolio')">
            {{ __('PORTFOLIO') }}
        </x-jet-responsive-nav-link>
    </div>
</div>
    ...
    <div class="flex flex-row items-center w-full space-x-10">
        <div class="flex flex-row items-center flex-grow h-20 bg-white rounded-none lg:rounded-r-full bg-opacity-80">
            ...
            <div class="flex flex-row justify-end flex-grow pr-6 space-x-20">
                <a href="{{url('/')}}" class="hidden p-2 px-10 text-lg text-center text-white transform bg-blue-600 bg-opacity-75 border border-gray-400 rounded-full md:block hover:scale-105">OVERVIEW</a>
                <a href="{{route('websites.portfolio')}}" class="hidden p-2 px-10 text-lg text-center text-white transform bg-blue-600 bg-opacity-75 border border-gray-400 rounded-full md:block hover:scale-105">PORTFOLIO</a>
        ...
        <div class="hidden lg:block prohide-p">
            <div class="flex flex-row items-center justify-end h-20 pl-6 pr-24 bg-white rounded-l-full bg-opacity-80">
                <a href="{{route('websites.inquire')}}" class="p-2 px-10 text-lg text-center text-white transform bg-blue-600 bg-opacity-75 border border-gray-400 rounded-full hover:scale-105">INQUIRE NOW</a>
            </div>
        </div>
    </div>
<div>